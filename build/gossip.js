...
var _initialiseProps = function _initialiseProps() {
    ...
    this.onhistory = function (history) {};

    this.onnotice = function (notice) {};
    ...
    this._init = function (nick, secret) {
        if (secret === "") {
    ...
    this.registerNick = function (nickReq) {
